                  ...
                  <AccordionItem value="basic-info">
                    ...
                    <AccordionContent>
                      <div className="space-y-2">
                        ...
                        <div>
                          <Label htmlFor="link" className="text-xs">Slug (Website URL)</Label>
                          <Input
                            disabled
                            id="link"
                            name="link"
                            value="Autogenerated or place ${domain.name}/${segment.name}/error${product.id} or it should map ${domain.name}/${segment.name}/${link.id or post.id}/ "
                            onChange={handleInputChange}
                            className="h-7 text-xs"
                          />
                        </div>
